...
//    /// <summary>
//    /// Mod entry point initializing configuration profiles and connecting to the Divine Intervention framework.
//    /// </summary>
//    public class MiniMapPerformanceMod : Mod
//    {
//        public static MiniMapPerformanceSettings Settings;

//        public MiniMapPerformanceMod(ModContentPack content) : base(content)
//        {
//            Settings = GetSettings<MiniMapPerformanceSettings>();

//            // Configure the shared framework logger for this mod instance context
//            // SUPER EASY LOGGING
...
//            DivineLog.Debug("This message is only logged in debug builds.");
//            DivineLog.Log.Warning("Wrapper around Verse.Log.Warning.");
//            DivineLog.Error("("Wrapper around Verse.Log.Warning.");");
//        }
//    }
